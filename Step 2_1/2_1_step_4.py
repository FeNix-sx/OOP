...
class Clock:
    ...
    def set_time(self, tm: int):
        ...
        :param tm: текущее время, int
        """
        self.__time = [self.__time, tm][self.__check_time(tm)]

    def get_time(self):
        """
        Получение текущего времени из приватной
    ...
    # private
    def __check_time(self, tm: int):
        """
        Проверка корректности времени tm
        :param tm: int, проверяемое время
        :return: bool
        """
