...
class Thing:
    ...
    def __eq__(self, other):
        ...
        if isinstance(other, Thing):
            return self.__name.lower() == other.__name.lower() and self.__mass == other.__mass
        raise TypeError("Ошибка! Должен быть экземпляр класса Thing")
