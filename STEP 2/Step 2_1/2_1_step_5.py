"""
Подвиг 4. Объявите класс с именем MoneyR и определите в нем следующие переменные и методы:

- приватная локальная переменная money (целочисленная) для хранения количества денег
    (своя для каждого объекта класса MoneyR);
...
- публичный метод add_money(mn) для прибавления средств из объекта mn класса MoneyR к средствам текущего объекта;
...
Пример использования класса MoneyR (эти строчки в программе не писать):
...
class Money :
    ...
    def add_money(self, mn):
        """
        Прибавление средств из объекта mn класса MoneyR к средствам текущего объекта
        :param mn:
        """
