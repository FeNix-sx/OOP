...
norm2(vector) - для вычисления квадратической нормы vector - переданного объекта класса
...
class RadiusVector2D:
    ...
    @x.setter
    def x(self, x):
        self.__x = [self.__x, x][self.__check_coord(x)]
    ...
    @y.setter
    def y(self, y):
        self.__y = [self.__y, y][self.__check_coord(y)]
