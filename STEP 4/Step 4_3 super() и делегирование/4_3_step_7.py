...
функция (в примере index), и если она существует,
...
инициализаторе __init__(self, methods)
прописываем параметр для декоратора, а магический метод __call__() объявляем
